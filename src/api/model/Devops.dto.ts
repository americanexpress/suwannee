 ...
 */
export class DevopsDto {

    @ApiModelProperty({required: true, enum: ['deploy', 'upgrade', 'instantiate']})
    ...
    @ApiModelProperty({required: false, isArray: true, type: 'String', collectionFormat: 'multi'})
